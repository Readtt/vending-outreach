...
export const modelSelectorTriggerVariants = cva(
  "flex w-fit items-center justify-between gap-1.5 overflow-hidden rounded-lg border border-transparent bg-clip-padding text-sm whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      variant: {
        outline:
      ...
      size: {
        ...
        sm: "h-7 rounded-[min(var(--radius-md),12px)] px-2 py-1 text-xs",
        lg: "h-9 px-3 py-2",
      },
    },
    defaultVariants: {
